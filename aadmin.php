...
// Table name 
	...
	$connection = mysqli_connect('localhost', 'root', '', 'dhun');
...
$sql="SELECT * FROM $tbl_name WHERE email1='$email1' and password1='$password1'";
...
// Register $myusername, $mypassword and redirect to file "login_success.php"
	...
	?>
<div class="maintext">
<span >Wrong username or password</span></div>
