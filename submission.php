...
mysqli_query($connect,"INSERT INTO user_input(Fname,Lname,Gender,email,password) VALUES('$Fname','$Lname','$Gender','$email','$password')");
?>
<html>
<head>
...
<div class="maintext">
<SPAN><a href="main_page.php">Click here to go back to login page</a></SPAN></div>
